...
@section('extra-js')
	{!! HTML::script('js/views/manage/location-add.js') !!}
@endsection
...
@section('content')
	...
	<div class="row">
		{!! Form::open(['url' => '/manage/location/add/' . $org->slug, 'class'=>'form-horizontal']) !!}
			<div class="col-md-8">
				<div class="control-group row">
					{!! Form::label('location', 'Location co-ordinates', ['class'=>"col-md-3  control-label"]) !!}
					<div class="col-md-2">
						<span id="hidden-location">0,0</span>
						{!! Form::hidden('latitude', null, ['class' => "form-control", 'placeholder' => ""]) !!}
						{!! Form::hidden('longitude', null, ['class' => "form-control", 'placeholder' => ""]) !!}
					</div>
				...
				<div class="control-group row">
					...
					<div class="col-md-2">
					{!! Form::checkbox('visibile', null, ['class' => "form-control", 'placeholder' => "Optional note, for admins, about this organisation"]) !!}
					</div>
